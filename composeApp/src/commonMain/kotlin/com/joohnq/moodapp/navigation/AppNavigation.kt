    ...
    navigation<NavigationGraph.App>(startDestination = Destination.App.DashBoard) {
        composable<Destination.App.DashBoard> {
            DashboardScreen(
                onEvent = { event ->
                    when (event) {
                        DashboardContract.Event.NavigateToAddJournaling -> {
                            onNavigate(Destination.App.AddSelfJournal)
                        }

                        DashboardContract.Event.NavigateToAddSleep -> {
                        ...
                        DashboardContract.Event.NavigateToAddStress -> {
                        ...
                        is DashboardContract.Event.NavigateToEditJournal -> {
                        ...
                        DashboardContract.Event.NavigateToMood -> {
                        ...
                        DashboardContract.Event.NavigateToStressLevel -> {
