...
data class MoodRecordResource(
    ...
    companion object{
        val moodRecordResourceDepressedPreview = MoodRecordResource(
            id = MoodResource.Depressed.id,
            mood = MoodResource.Depressed,
            description = "Description",
        )

        val moodRecordResourceSadPreview = MoodRecordResource(
            id = MoodResource.Sad.id,
            mood = MoodResource.Sad,
            description = "Description",
        )

        val moodRecordResourceNeutralPreview = MoodRecordResource(
            id = MoodResource.Neutral.id,
            mood = MoodResource.Neutral,
            description = "Description",
        )

        val moodRecordResourceHappyPreview = MoodRecordResource(
            id = MoodResource.Happy.id,
            mood = MoodResource.Happy,
            description = "Description",
        )

        val moodRecordResourceOverjoyedPreview = MoodRecordResource(
