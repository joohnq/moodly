...
fun ExpressionAnalysisUI(
    ...
    ScaffoldSnackBar(
        ...
        Column(
            ...
            TopBar(onGoBack = { onEvent(ExpressionAnalysisContract.Event.GoBack) })
            ...
            ExpressionAnalysisTextField(
                ...
                onValueChange = {
                    onIntent(
                        AddMoodContract.Intent.UpdateDescription(it)
                    )
                }
            )
            VerticalSpacer(24.dp)
            if (description.isNotEmpty())
                ContinueButton(
                    ...
                    onClick = { onEvent(ExpressionAnalysisContract.Event.Add) }
                )
        }
    }
}