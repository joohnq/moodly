...
data class SelfJournalRecordResource(
    ...
    companion object {
        ...
        val selfJournalRecordResourceSadPreview =
            SelfJournalRecordResource(
        ...
        val selfJournalRecordResourceNeutralPreview =
            SelfJournalRecordResource(
        ...
        val selfJournalRecordResourceHappyPreview =
            SelfJournalRecordResource(
        ...
        val selfJournalRecordResourceOverjoyedPreview =
            SelfJournalRecordResource(
        ...
        val allSelfJournalRecordResourcePreview =
            listOf(
