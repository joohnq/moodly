...
fun AddJournalingUI(
    ...
    state: AddJournalContract.State,
    onIntent: (AddJournalContract.Intent) -> Unit = {},
    onEvent: (AddJournalContract.Event) -> Unit = {},
) {
    ...
    ScaffoldSnackBar(
        ...
        Column(
            ...
            Column(
                ...
                TopBar(
                    onGoBack = { onEvent(AddJournalContract.Event.GoBack) },
                ...
                CustomOutlinedTextField(
                    ...
                    onValueChange = { title ->
                        onIntent(
                            AddJournalContract.Intent.UpdateTitle(title)
                        )
                    },
                )
                ...
                LazyRow(
                    ...
                    items(moods) { resource ->
                        MoodFace(
                            ...
                            onClick = {
                                onIntent(
                                    AddJournalContract.Intent.UpdateMood(resource)
                                )
                            }
                        )
                    }
                ...
                ExpressionAnalysisTextField(
                    ...
                    onValueChange = {
                        onIntent(
                            AddJournalContract.Intent.UpdateDescription(it)
                        )
                    }
                )
            }
            Column(
                ...
                ContinueButton(
                    ...
                    enabled = canContinue,
                    onClick = { onEvent(AddJournalContract.Event.Add) }
                )
            }
        }
    }
