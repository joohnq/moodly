...
data class StressLevelRecordResource(
    ...
    companion object{
        val stressLevelRecordResourceOnePreview = StressLevelRecordResource(
            id = StressLevelResource.One.id,
            stressLevel = StressLevelResource.One,
        )

        val stressLevelRecordResourceTwoPreview = StressLevelRecordResource(
            id = StressLevelResource.Two.id,
            stressLevel = StressLevelResource.Two,
        )

        val stressLevelRecordResourceThreePreview = StressLevelRecordResource(
            id = StressLevelResource.Three.id,
            stressLevel = StressLevelResource.Three,
        )

        val stressLevelRecordResourceFourPreview = StressLevelRecordResource(
            id = StressLevelResource.Four.id,
            stressLevel = StressLevelResource.Four,
        )

        val stressLevelRecordResourceFivePreview = StressLevelRecordResource(
            id = StressLevelResource.Five.id,
            stressLevel = StressLevelResource.Five,
        )

        val stressLevelRecordResourceWithStressorsPreview = StressLevelRecordResource(
            id = 6,
            stressLevel = StressLevelResource.Five,
