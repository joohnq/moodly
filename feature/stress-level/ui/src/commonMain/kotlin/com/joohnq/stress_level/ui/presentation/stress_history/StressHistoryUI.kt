...
import com.joohnq.stress_level.ui.resource.mapper.toGroupedByDate
...
fun StressHistoryUI(
    ...
    onEvent: (StressHistoryContract.Event) -> Unit = {},
) {
            ...
            Scaffold(
                ...
                Column(
                    ...
                    TopBar(
                        ...
                        isDark = true,
                        onGoBack = { onEvent(StressHistoryContract.Event.GoBack) }
                    )
                    ...
                    LazyColumn(
                        ...
                        items(
                            ...
                            SwipeTorRevealCard(
                                modifier = Modifier.fillMaxWidth(),
                                onAction = {
                                    onIntent(StressLevelContract.Intent.Delete(record.id))
                                }
                            ) { modifier ->
