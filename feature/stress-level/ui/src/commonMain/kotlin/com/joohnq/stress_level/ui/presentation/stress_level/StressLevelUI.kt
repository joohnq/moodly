...
import com.joohnq.stress_level.ui.resource.mapper.getTodayStressLevelRecord
    ...
    state.records.handle(
        onSuccess = { records ->
            ...
            DecoratedConvexPanelList(
                ...
                onAddButton = { onEvent(StressLevelContract.Event.AddStressLevel) },
                onGoBack = { onEvent(StressLevelContract.Event.GoBack) },
                content = { modifier ->
                    StressContent(
                        modifier = modifier,
                        records = records,
